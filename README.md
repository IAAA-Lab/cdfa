...
- fuseki : a folder with the configuration of a Fuseki SPARQL end-point container
...
- app.py: Python file that implements and deploys the Linked Data portal using Flask.
